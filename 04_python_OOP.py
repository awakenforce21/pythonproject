...
#
#     def is_scholarship(self):                # instance method
#         if self.grade > Student.scholarship_rate: #self도 해도 됨됨
#             return True
#         else:
#             return False
#
...
#
# student = Student("홍길동","심리학과","20203311",4.0)
# print(student.__dept) #private 처리를 한 거예요!
# student.__dept = "컴퓨터"
